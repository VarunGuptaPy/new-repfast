...
import { Bot, Linkedin, Twitter, Zap, Brain, Target, CheckCircle, ArrowRight, Sparkles } from "lucide-react";
      ...
      <div className="relative overflow-hidden min-h-[90vh] flex items-center pt-16">
        ...
        >
          <div className="text-center">
            ...
            >
              RepFast learns your engagement style and automatically responds to relevant posts in your feed, 
              maintaining your authentic voice across social media.
            </motion.p>
      ...
      <div id="features" className="py-24 bg-background/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold mb-4">Intelligent Engagement Features</h2>
            <p className="text-muted-foreground">Powered by advanced AI to maintain your authentic online presence</p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Analyzes your past interactions to understand your engagement patterns and preferences"
              },
              {
                icon: Target,
                title: "Targeted Responses",
                description: "Identifies and engages with posts that match your usual interaction patterns"
              },
              {
                icon: Bot,
                title: "Authentic Voice",
                description: "Maintains your unique communication style in every interaction"
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <div id="how-it-works" className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Three simple steps to automated engagement</p>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="relative flex items-center gap-8">
                <div className="flex-shrink-0 w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center border-2 border-primary relative">
                  <span className="absolute -top-2 -left-2 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-lg font-bold">1</span>
                  <Twitter className="h-10 w-10 text-primary" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Connect Your Profile</h3>
                  <p className="text-muted-foreground text-lg">
                    Link your X (Twitter) account to RepFast. It's quick, secure, and only takes a few clicks.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center gap-8">
                <div className="flex-shrink-0 w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center border-2 border-primary relative">
                  <span className="absolute -top-2 -left-2 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-lg font-bold">2</span>
                  <Brain className="h-10 w-10 text-primary" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">AI Learning Phase</h3>
                  <p className="text-muted-foreground text-lg">
                    RepFast analyzes your past interactions to understand your engagement style, tone, and preferences.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-center gap-8">
                <div className="flex-shrink-0 w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center border-2 border-primary relative">
                  <span className="absolute -top-2 -left-2 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-lg font-bold">3</span>
                  <Bot className="h-10 w-10 text-primary" />
                </div>
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Automatic Engagement</h3>
                  <p className="text-muted-foreground text-lg">
                    RepFast begins responding to relevant posts in your feed, maintaining your authentic voice.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="py-24 bg-background/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground mb-8">Watch how RepFast transforms your social media engagement</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8 bg-card">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground mb-4">Perfect for individuals and creators</p>
                <div className="text-4xl font-bold mb-4">$29<span className="text-lg text-muted-foreground">/mo</span></div>
              </div>
            ...
            <Card className="p-8 bg-card relative overflow-hidden">
              ...
              <div className="mb-6">
                ...
                <div className="text-4xl font-bold mb-4">$79<span className="text-lg text-muted-foreground">/mo</span></div>
              </div>
              <ul className="space-y-3 mb-8">
                {[
